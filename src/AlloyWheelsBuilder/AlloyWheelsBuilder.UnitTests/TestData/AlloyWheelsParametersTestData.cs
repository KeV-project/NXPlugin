...
namespace AlloyWheelsBuilder.UnitTests.TestData
{
	...
	public static class AlloyWheelsParametersTestData
	{
        ...
        public static Dictionary<AlloyWheelsParameterName, string>
            ParameterRussianNames => new Dictionary<AlloyWheelsParameterName,
                string>
            {
                { AlloyWheelsParameterName.Diameter,
                    "Диаметр D" },
        ...
        public static Dictionary<AlloyWheelsParameterName,
            AlloyWheelsParameterName> CodependentParameterName => new
        ...
        /// </summary>
        public static Dictionary<AlloyWheelsParameterName, string> Units =
